...
public class JsonConnectionCacheTests
{
    public class TheLoadMethod : TestBaseClass
    {
        ...
        public async Task IsLoadedFromCache()
        {
            ...
            Assert.AreEqual(new Uri("https://api.github.com"), connections[0].HostAddress.ApiUri);
            Assert.AreEqual(new Uri("https://github.enterprise/api/v3/"), connections[1].HostAddress.ApiUri);
        }
